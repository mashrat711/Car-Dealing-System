                    ...
                    <div class="page-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="page-header card">
                                    <div class="card-block">
                                        <form action="{{route('car_specifications.store')}}" method="post"   encType ="multipart/form-data">
                                            @csrf
                                   ...
                                   <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    <label for="exampleFormControlFile1">Banner1:</label>
                                                    <input type="file" name="banner1" class="form-control-file" id="exampleFormControlFile1">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for="exampleFormControlFile1">Banner2:</label>
                                                    <input type="file" name="banner2" class="form-control-file" id="exampleFormControlFile1">
                                                </div>

                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    <label for="exampleFormControlFile1">Banner3:</label>
                                                    <input type="file" name="banner3" class="form-control-file" id="exampleFormControlFile1">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for=""  class="block">Video1</label>

                                                    <input id="userName-2b" name="video1" type="text" class=" form-control"
                                                           value="{{ old("video1") ? old("video1") : (!empty($result) ? $result->video1: null) }}">
                                                </div>

                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    <label for=""  class="block">Video2</label>

                                                    <input id="userName-2b" name="video2" type="text" class=" form-control"
                                                           value="{{ old("video2") ? old("video2") : (!empty($result) ? $result->video2: null) }}">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for="exampleFormControlFile1">Listing Photo:</label>
                                                    <input type="file" name="extra" class="form-control-file" id="exampleFormControlFile1">
                                                </div>
