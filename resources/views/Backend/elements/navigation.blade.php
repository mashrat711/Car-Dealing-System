...
{{--@can('attendance')--}}
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="pcoded-hasmenu {{'' == request()->path() ? 'active' :''}}">
                ...
                <ul class="pcoded-submenu">
                    <li class=" {{'car_models.index' == request()->path() ? 'active' :''}}">
                        <a href="{{route('car_specifications.index')}}">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="pcoded-hasmenu {{'attendences' == request()->path() ? 'active' :''}}">
                <a href="javascript:void(0)">
                    <span class="pcoded-micon"><i class="fa fa-file-text"></i><b>AC</b></span>
                    <span class="pcoded-mtext">Billing Details</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
                    <li class=" {{'jobCategories.index' == request()->path() ? 'active' :''}}">
                        <a href="/billings">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext">All Records</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
            ...
            <li class="pcoded-hasmenu {{'attendences' == request()->path() ? 'active' :''}}">
                <a href="javascript:void(0)">
                    <span class="pcoded-micon"><i class="fa fa-file-text"></i><b>AC</b></span>
                    <span class="pcoded-mtext">Shipping Details</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
                    <li class=" {{'shippings.index' == request()->path() ? 'active' :''}}">
                        <a href="{{'/shippings'}}">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext">All Records</span>
                            <span class="pcoded-mcaret"></span>
            ...
            <li class="pcoded-hasmenu {{'attendences' == request()->path() ? 'active' :''}}">
                <a href="javascript:void(0)">
                    <span class="pcoded-micon"><i class="fa fa-file-text"></i><b>AC</b></span>
                    <span class="pcoded-mtext">Purchase Details</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
                    <li class=" {{'/purchases' == request()->path() ? 'active' :''}}">
                        <a href="{{'/purchases'}}">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext">All Records</span>
                            <span class="pcoded-mcaret"></span>
            ...
            <li class="pcoded-hasmenu {{'attendences' == request()->path() ? 'active' :''}}">
                <a href="javascript:void(0)">
                    <span class="pcoded-micon"><i class="fa fa-file-text"></i><b>AC</b></span>
                    <span class="pcoded-mtext">Checkout Details</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
                    <li class=" {{'checkout.index' == request()->path() ? 'active' :''}}">
